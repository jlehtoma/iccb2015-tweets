...
#tweets <- searchTwitter("#ICCB2015")

# Make request on daily basis and use date as a timestamp
#today <- Sys.Date()
#saveRDS(tweets, file.path("data", paste0("raw_tweets_", today, ".rds")))
...
The dataset accumulated during the conference will be available as a CSV file 
from figshare after the conference.
...
| Description | n |
|-------------|---|
| Tweets with the `#ICCB2015` hashtag starting from July 22nd: | `r nrow(dt_tweets)` |
